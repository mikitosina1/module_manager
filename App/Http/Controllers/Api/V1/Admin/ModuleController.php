...
use Modules\ModuleManager\App\Http\Request\ModuleActionRequest;
...
{
    public function index(ModuleManagerService $service): AnonymousResourceCollection
    {
    ...
    public function enable(ModuleActionRequest $request, EnableModuleAction $action): JsonResponse
    {
        /** @var Module $module */
    ...
    public function disable(ModuleActionRequest $request, DisableModuleAction $action): JsonResponse
    {
        $module = $action->execute($request->moduleName());
    ...
    public function destroy(ModuleActionRequest $request, DeleteModuleAction $action): JsonResponse
    {
